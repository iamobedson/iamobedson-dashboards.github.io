...
3. If we go with a product placement campaign with DanTDM, this could  generate the client approximately $484,000 per video. If we advance with an influencer marketing campaign deal instead, the client would have a one-off net profit of $404,000.
...
We'll have conversations with the marketing client to forecast what they also expect from this collaboration. Once we observe that we're hitting the expected milestones, we'll advance with potential partnerships with DanTDM, Mister Max, and NoCopyrightSounds channels in the future.   
